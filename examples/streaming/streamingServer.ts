// ---------------------------------------------------------------------------
// Flowneer — Streaming Server (native stream() API + generator steps)
// ---------------------------------------------------------------------------
// Demonstrates the current streaming approach:
//   1. FlowBuilder.stream() async generator instead of the legacy withStream plugin
...
//
// Two endpoints are served on port 3001:
//
